...
<section class="max-w-7xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center gap-12">
    <div class="flex-1 space-y-8">
        <span
            class="inline-block px-4 py-1.5 bg-indigo-100 text-indigo-700 rounded-full text-sm font-bold uppercase tracking-wider">Platform Event Kampus</span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div
            ...
            <div class="relative overflow-hidden aspect-[3/4]">
                <img src="{{ $event->poster_path ? asset('storage/' . $event->poster_path) : $dummyImage }}" alt="{{ $event->title }}"
                ...
                <div
                    ...
                    {{ $event->category->name ?? 'Update' }}</div>
            </div>
            <div class="p-6">
...
<div class="w-full bg-slate-900 text-slate-300 py-4 border-t border-slate-800">
    <div class="max-w-7xl mx-auto px-6 text-center text-sm">
        <p>🎓 Aplikasi ini sekedar untuk bahan demo materi matakuliah <strong>Digital Bisnis</strong> di <strong>Universitas Amikom Yogyakarta</strong>. <span class="text-indigo-400 font-semibold">Demo purpose only.</span></p>
    </div>
</div>
@endsection
